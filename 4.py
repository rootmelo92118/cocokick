...
#==============================================================================#
botStart = time.time()
cl = LINE("EtQcdKh7GQvLODduuFC1.LuvPdjZJJfWn3Kdw6aHBOq./TJ+k0peT0r1861uR9tJGvU/VNjcpAQBukH2tTEbZYo=")
baime = LINE("Et68XpueEp4ZUHtEYzje.VJ7z0J4e/d5kiF5mT9U5FG.AStNIr5YieTwsuH7bg22XrG6pIF1XNLbPN9ufwLghNQ=")
orange = LINE("EtVhwdOnvlkqVVFQeRCe.Mt92J0fQTAU7vrft+4RdJG.SnTraOahLZeni4H64XwtvaPLJGmNlwCv7A/4mZiMLAw=")
ghost01 = LINE("EtpR6ahYt1cESQfv2x2f.uifK08jVAVQUFFGPGWbhlW.Lec3OR37cIF4kGSiSdx61f57ZiSx80xg0g9pNX4k2ec=")
ghost02 = LINE("EtIrKo1IMENoaOFDFqIb.0NUmZEsh6+Dhqa7uTfcJsW.aNylKeC7Psfm3HZO/0ol2J0cRi5YsKXBCpFBWP0UrtA=")
kicker01 = LINE("EtyyvpRbcWgy8VnnT7v1.X/9n3an1J75BajgVvEY6eq.h9PszC3dbIEwLdi2j0YKJCM5xg/DO7E4szUXr8FbwLo=")
kicker02 = LINE("EtAJ8V127Er6wH9TnM70.VvcMElkI+oGtJgVyFHXxea.YFO6S1MEBcghhG6cCEi0STEgEFOBC3JWs5QZFALMc3Q=")
kicker03 = LINE("EtNo8BFtm4xHASIdmG4e.opN1tRH4fPR+iMwCSwxRtG.Mh2kedAeq9q5OooQDVOehz8XE6r8fYfhTBnTr0Zpxuw=")
kicker04 = LINE("EtizRuKqZaqYbBeiOJv6.5DosnUnAyvWEKXtHvj5wbG.T/69wAW96o7mW5ZWr4Lu6mxHTEImnXLwHdVhO+Z1sxA=")
kicker05 = LINE("EtBDj0yH7hL2P4rt9XRc.1nliY+fcMel8l2xN8erKFa.tBlgaGBHxl8OwLZYgJND7vbr+lChGBgl2I1f4D1G0jQ=")
kicker06 = LINE("EtnbLyMvv5o31NKzxW82.wHI264N/gj4V/ahEyGooiG.vF6ss3xHjxTLe7gswqVyw4GIkFa70zaGcm47A2Od2rg=")
kicker07 = LINE("Et4L6H2FY8eAoreXhJP8.7/1TD4h3gGX/VhsGVzUvMa.WdMI7XJKNwxARKCEgF8II+tbqS8kdMiL0lTdTQxDaFE=")
kicker08 = LINE("EtnG41bTMblZ08c1bQq7.zqLdC8TXR+RFywS1uE47zW.WEdANPAofKsnvK/wRrf3XwN6W27tkPLAON6j8L0CVGE=")
kicker09 = LINE("EtffojABt3Yruz8boo3e.ZiheIROvDTnbhzPKPFPyZG.QkczQmb+qTx65/RE8qOsvMbajVwUaUAzA1mu9PBOQfE=")
kicker10 = LINE("EtJbrH6bhE5JHykHqzCc.26tehiskzNeYEvtImOkYla.fsWswlM1wbdzJhgor9VafYthWLbnAo5EejgchsLuzrc=")
print ("======登入成功=====")
#ghost01 = ghost02
#kicker05 = kicker01
#kicker07 = kicker02
            ...
            if op.param1 in settings["LeaveText"]:
                if op.param2 in Bots:
                    ...
                    try:
                        ...
                        aa = (aa[:int(len(aa)-1)])
                        cl.sendMessage(op.param1, "我們的 @coco 離開了群組"+ginfo , contentMetadata={'MENTION':'{"MENTIONEES":['+aa+']}'}, contentType=0)
                    except Exception as e:
                        print(str(e))
        if op.type == 17:
            if op.param1 in settings["JoinText"]:
                if op.param2 in bots:
                    ...
                    try:
                        ...
                        aa = """{"S":"""+json.dumps(str(strt))+""","E":"""+json.dumps(str(akh))+""","M":"""+json.dumps(op.param2)+"},"""
                        aa = (aa[:int(len(aa)-1)])
                        cl.sendMessage(op.param1, "歡迎 @coco 加入"+ginfo , contentMetadata={'MENTION':'{"MENTIONEES":['+aa+']}'}, contentType=0)
                    except Exception as e:
                        print(str(e))
